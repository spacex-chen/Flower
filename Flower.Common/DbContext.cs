...
namespace xFlower.Common
{
    public class DbContext
    {
        ...
        {
            //数据库连接字符串
            ConnectionString = "Data Source=192.168.0.101;Initial Catalog=FlowerDB;Persist Security Info=True;User ID=sa;Password=SA@12345",
            // 数据库类型
        ...
        public static void InitDataBase()
        {
            ...
            string nspace = "xFlower.Model.Entitys";
            Type[] ass = Assembly.LoadFrom("bin/DEBUG/net8.0/xFlower.Model.dll").GetTypes().Where(p => p.Namespace == nspace).ToArray();
